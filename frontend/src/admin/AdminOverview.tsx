...
const Card = ({ children, style = {} }: any) => (
  <div style={{ backgroundColor: '#FAF6EE', color: '#0F172A', border: '2px solid #0F172A', borderRadius: '1rem', padding: '1.5rem', boxShadow: '6px 6px 16px rgba(139, 120, 95, 0.15), -6px -6px 16px #FFFFFF', ...style }}>
    {children}
  </div>
);
...
export default function AdminOverview({ setActiveTab }: { setActiveTab?: (tab: string) => void }) {
  ...
  const colors = ['#E11D48', '#8B5CF6', '#F59E0B', '#10B981', '#F43F5E', '#1E293B'];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', color: '#0F172A', paddingBottom: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 800, margin: '0 0 0.5rem 0' }}>Welcome back, Admin <span style={{ fontSize: '1.25rem' }}>👋</span></h1>
          <p style={{ color: '#1E293B', margin: 0, fontSize: '0.9rem' }}>Here's what's happening with your smart campus AI interview system today.</p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem' }}>
        <Card style={{ position: 'relative', overflow: 'hidden', paddingBottom: 0 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
            <div>
              <p style={{ color: '#1E293B', fontSize: '0.8rem', margin: '0 0 0.5rem 0' }}>Total Interviews</p>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                <h2 style={{ fontSize: '2rem', fontWeight: 700, margin: 0 }}>{stats?.total_interviews || 0}</h2>
                {stats?.interviews_growth !== undefined && (
                  <span style={{ color: stats.interviews_growth >= 0 ? '#10B981' : '#EF4444', fontSize: '0.75rem', fontWeight: 800 }}>
                    {stats.interviews_growth >= 0 ? '↑' : '↓'} {Math.abs(stats.interviews_growth)}%
                  </span>
                )}
              </div>
              <p style={{ color: '#1E293B', fontSize: '0.7rem', margin: '0.25rem 0 0 0' }}>vs last week</p>
            </div>
            <div style={{ backgroundColor: 'rgba(76, 5, 25, 0.4)', border: '1px solid #4C0519', borderRadius: '0.5rem', padding: '0.4rem 0.75rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontSize: '0.65rem', color: '#FDA4AF', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 800 }}>Today</span>
        ...
        <Card style={{ position: 'relative', overflow: 'hidden', paddingBottom: 0 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
            <div>
              <p style={{ color: '#1E293B', fontSize: '0.8rem', margin: '0 0 0.5rem 0' }}>Candidates</p>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                <h2 style={{ fontSize: '2rem', fontWeight: 700, margin: 0 }}>{stats?.total_students || 0}</h2>
                {stats?.students_growth !== undefined && (
                  <span style={{ color: stats.students_growth >= 0 ? '#10B981' : '#EF4444', fontSize: '0.75rem', fontWeight: 800 }}>
            ...
            <div style={{ backgroundColor: 'rgba(6, 78, 59, 0.4)', border: '1px solid #064E3B', borderRadius: '0.5rem', padding: '0.4rem 0.75rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontSize: '0.65rem', color: '#6EE7B7', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 800 }}>Resumes</span>
        ...
        <Card style={{ position: 'relative', overflow: 'hidden', paddingBottom: 0 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
            <div>
              <p style={{ color: '#1E293B', fontSize: '0.8rem', margin: '0 0 0.5rem 0' }}>AI Evaluations</p>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                ...
                {stats?.completed_interviews_growth !== undefined && (
                  <span style={{ color: stats.completed_interviews_growth >= 0 ? '#10B981' : '#EF4444', fontSize: '0.75rem', fontWeight: 800 }}>
            ...
            <div style={{ backgroundColor: 'rgba(76, 29, 149, 0.4)', border: '1px solid #4C1D95', borderRadius: '0.5rem', padding: '0.4rem 0.75rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontSize: '0.65rem', color: '#C4B5FD', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 800 }}>Pending</span>
        ...
        <Card style={{ position: 'relative', overflow: 'hidden', paddingBottom: 0 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
            <div>
              <p style={{ color: '#1E293B', fontSize: '0.8rem', margin: '0 0 0.5rem 0' }}>Avg. Score</p>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                <h2 style={{ fontSize: '2rem', fontWeight: 700, margin: 0 }}>{stats?.avg_final_score || 0}<span style={{ fontSize: '1rem', color: '#1E293B' }}>/100</span></h2>
                {stats?.avg_score_growth !== undefined && (
                  <span style={{ color: stats.avg_score_growth >= 0 ? '#10B981' : '#EF4444', fontSize: '0.75rem', fontWeight: 800 }}>
            ...
            <div style={{ backgroundColor: 'rgba(245, 158, 11, 0.1)', border: '1px solid #FCD34D', borderRadius: '0.5rem', padding: '0.35rem 0.6rem', display: 'flex', flexDirection: 'column', gap: '0.15rem', minWidth: '70px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.65rem' }}>
                <span style={{ color: '#F59E0B', fontWeight: 800 }}>TECH</span>
                <span style={{ color: '#0F172A', fontWeight: 700 }}>{stats?.avg_technical_score || 0}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.65rem' }}>
                <span style={{ color: '#F59E0B', fontWeight: 800 }}>HR</span>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '1.5rem' }}>
        ...
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: 0 }}>Interviews Over Time</h3>
          ...
          <div style={{ height: '240px' }}>
              <ResponsiveContainer width="100%" height="100%">
                ...
                <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: '#1E293B' }} dy={10} />
                <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: '#1E293B' }} dx={-10} />
                <RechartsTooltip 
                  contentStyle={{ backgroundColor: '#FFFFFF', border: '2px solid #0F172A', borderRadius: '0.5rem', color: '#E11D48', fontSize: '0.8rem' }}
        ...
        <Card style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          <h3 style={{ fontSize: '1.1rem', fontWeight: 800, margin: '0 0 1.5rem 0', color: '#0F172A' }}>Interviews by Department</h3>
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '2rem', flex: 1 }}>
            ...
            <div style={{ flex: '1 1 200px', height: '220px', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center' }}>
                ...
                <p style={{ margin: 0, fontSize: '0.75rem', color: '#1E293B', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Total</p>
              </div>
            </div>
              ...
              {pieData.map((d, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem' }}>
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem', flex: 1 }}>
                    ...
                    <span style={{ color: '#0F172A', fontSize: '0.85rem', fontWeight: 700, lineHeight: 1.4, wordBreak: 'break-word' }}>{d.name}</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
                    <span style={{ color: '#0F172A', fontWeight: 800, fontSize: '0.9rem' }}>{d.value}</span>
          ...
          <div style={{ textAlign: 'right', marginTop: '2rem', borderTop: '2px solid #0F172A', paddingTop: '1rem' }}>
            <span style={{ fontSize: '0.85rem', color: '#E11D48', cursor: 'pointer', fontWeight: 800, display: 'inline-flex', alignItems: 'center', gap: '0.25rem' }}>
        ...
        <Card style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: 0 }}>Upcoming Interviews</h3>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', flex: 1 }}>
            {(stats?.upcoming_interviews || []).map((u: any, i: number) => (
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#FFFFFF', padding: '0.75rem', borderRadius: '0.5rem', border: '2px solid #0F172A', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: '0.8rem', fontWeight: 800, margin: 0, color: '#0F172A' }}>{u.name}</h4>
                    <p style={{ fontSize: '0.7rem', color: '#1E293B', margin: 0 }}>{u.role}</p>
                  </div>
                </div>
                <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.35rem' }}>
                  <p style={{ fontSize: '0.75rem', color: '#0F172A', margin: 0 }}>{u.time}</p>
                  <button 
            ...
            {(stats?.upcoming_interviews || []).length === 0 && (
              <p style={{ margin: 0, fontSize: '0.8rem', color: '#1E293B', padding: '1rem', textAlign: 'center' }}>No pending interviews.</p>
            )}
          </div>
          <div style={{ textAlign: 'right', marginTop: '1rem' }}>
            <span style={{ fontSize: '0.75rem', color: '#E11D48', cursor: 'pointer', fontWeight: 700 }}>View Calendar →</span>
          </div>
        </Card>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1.5rem' }}>
        ...
        {/* Radar Chart */}
        <Card>
          <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: '0 0 1rem 0' }}>AI Evaluation Summary</h3>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', fontSize: '0.75rem', color: '#1E293B', marginBottom: '0.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              <div style={{ width: '12px', height: '2px', backgroundColor: '#E11D48' }}></div> This Week
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              <div style={{ width: '12px', height: '2px', backgroundColor: '#1E293B', borderStyle: 'dashed' }}></div> Last Week
            </div>
          </div>
          <div style={{ height: '300px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <RadarChart cx="50%" cy="50%" outerRadius="70%" data={stats?.radar_data || []}>
                ...
                <RechartsTooltip contentStyle={{ backgroundColor: '#FFFFFF', border: '2px solid #0F172A', borderRadius: '0.5rem', color: '#E11D48' }} />
              </RadarChart>
            </ResponsiveContainer>
          </div>
        </Card>
        ...
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: 0 }}>Candidate Performance Distribution</h3>
            <div style={{ backgroundColor: '#E11D48', padding: '0.25rem 0.5rem', borderRadius: '0.25rem', fontSize: '0.75rem', color: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '0.25rem', cursor: 'pointer' }}>
          ...
          <div style={{ height: '250px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={stats?.bar_data || []} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <RechartsTooltip cursor={{fill: '#E2E8F0'}} contentStyle={{ backgroundColor: '#FFFFFF', border: '2px solid #0F172A', borderRadius: '0.5rem', color: '#E11D48' }} />
        ...
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: 0 }}>AI Insights</h3>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {(stats?.ai_insights || []).map((insight: any, i: number) => (
              <div key={i} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                ...
                <p style={{ margin: 0, fontSize: '0.8rem', color: '#0F172A', lineHeight: 1.5 }}>{insight.text}</p>
              </div>
            ))}
          </div>
        </Card>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1.5fr 1.5fr', gap: '1.5rem' }}>
        ...
        {/* Quick Actions */}
        <Card>
          <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: '0 0 1rem 0' }}>Quick Actions</h3>
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            <button onClick={() => setActiveTab?.('Interviews')} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', backgroundColor: 'transparent', border: '1px solid #0F172A', padding: '0.4rem 0.75rem', borderRadius: '0.5rem', color: '#0F172A', fontSize: '0.75rem', cursor: 'pointer' }}>
              <Plus size={14} /> Schedule Interview
            </button>
            <button onClick={() => setActiveTab?.('Candidates')} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', backgroundColor: 'transparent', border: '1px solid #0F172A', padding: '0.4rem 0.75rem', borderRadius: '0.5rem', color: '#0F172A', fontSize: '0.75rem', cursor: 'pointer' }}>
              <UserPlus size={14} /> Add Candidate
            </button>
            <button onClick={() => setActiveTab?.('Reports')} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', backgroundColor: 'transparent', border: '1px solid #0F172A', padding: '0.4rem 0.75rem', borderRadius: '0.5rem', color: '#0F172A', fontSize: '0.75rem', cursor: 'pointer' }}>
              <FileText size={14} /> Generate Report
            </button>
            <button onClick={() => setActiveTab?.('AI Evaluations')} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', backgroundColor: 'transparent', border: '1px solid #0F172A', padding: '0.4rem 0.75rem', borderRadius: '0.5rem', color: '#0F172A', fontSize: '0.75rem', cursor: 'pointer' }}>
              <BrainCircuit size={14} /> AI Evaluation Rules
            </button>
            <button onClick={() => setActiveTab?.('Settings')} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', backgroundColor: 'transparent', border: '1px solid #0F172A', padding: '0.4rem 0.75rem', borderRadius: '0.5rem', color: '#0F172A', fontSize: '0.75rem', cursor: 'pointer' }}>
        ...
        {/* System Status */}
        <Card>
          <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: '0 0 1rem 0' }}>System Status</h3>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            {(stats?.system_status || []).map((sys: any, i: number) => (
              <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', fontSize: '0.75rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', color: '#1E293B' }}><Server size={14} /> {sys.name}</div>
                <div style={{ color: sys.color, display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
                  ...
                  <span style={{ fontWeight: 800 }}>{sys.status}</span>
                </div>
                {sys.metric && <div style={{ color: '#1E293B', fontSize: '0.65rem' }}>{sys.metric}</div>}
              </div>
            ))}
          </div>
        </Card>
        ...
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            <h3 style={{ fontSize: '0.9rem', fontWeight: 800, margin: 0 }}>Recent Activity</h3>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', flex: 1, overflowY: 'auto' }}>
            {(stats?.recent_activity?.slice(0, 3) || []).map((activity: any, i: number) => (
              <div key={i} style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  <p style={{ margin: '0 0 0.25rem 0', fontSize: '0.8rem', color: '#0F172A' }}>Interview {activity.status} for {activity.name}</p>
                  <p style={{ margin: 0, fontSize: '0.7rem', color: '#1E293B' }}>{new Date(activity.date).toLocaleString()}</p>
                </div>
              </div>
            ))}
            {(!stats?.recent_activity || stats.recent_activity.length === 0) && (
              <p style={{ margin: 0, fontSize: '0.8rem', color: '#1E293B' }}>No recent activity.</p>
            )}
          </div>
        </Card>
      </div>

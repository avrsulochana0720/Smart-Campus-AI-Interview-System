  ...
  return (
    <div style={{ paddingBottom: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#0F172A', margin: 0 }}>Skill Insights</h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem', marginBottom: '1.5rem' }}>
        ...
        <div style={{ backgroundColor: '#FAF6EE', borderRadius: '1rem', border: '1px solid #334155', padding: '1.5rem' }}>
          <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#0F172A', margin: '0 0 1rem 0', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><TrendingUp size={18} color="#22C55E"/> Surging Skills (Top 3)</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {(data.surging || []).map((s: any, i: number) => (
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem', backgroundColor: '#0F172A', borderRadius: '0.5rem', borderLeft: `3px solid ${s.color}` }}>
      ...
      <div style={{ backgroundColor: '#FAF6EE', borderRadius: '1rem', border: '1px solid #334155', padding: '1.5rem' }}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#0F172A', margin: '0 0 1rem 0', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Layers size={18} color="#E11D48"/> Overall Campus Competency Distribution</h3>
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}>
          <div style={{ backgroundColor: '#FAF6EE', padding: '2rem', borderRadius: '0.75rem', border: '1px solid #334155', width: '500px', maxWidth: '90%' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <h2 style={{ fontSize: '1.25rem', color: '#0F172A', margin: 0 }}>Address Skill Gap</h2>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <label style={{ display: 'block', color: '#64748B', fontSize: '0.85rem', marginBottom: '0.5rem' }}>Target Skill</label>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <button onClick={() => setSelectedGap(null)} style={{ flex: 1, padding: '0.75rem', backgroundColor: 'transparent', border: '1px solid #475569', color: '#64748B', borderRadius: '0.5rem', cursor: 'pointer' }}>Cancel</button>
              <button onClick={() => {
      ...
      {selectedSkill && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}>
          <div style={{ backgroundColor: '#FAF6EE', padding: '2rem', borderRadius: '0.75rem', border: '1px solid #334155', width: '450px', maxWidth: '90%', textAlign: 'center' }}>
            ...
            <h2 style={{ fontSize: '1.75rem', color: '#0F172A', margin: '0 0 0.5rem 0', fontWeight: 700 }}>{selectedSkill.name}</h2>
            ...
            <button onClick={() => setSelectedSkill(null)} style={{ width: '100%', padding: '0.75rem', backgroundColor: '#475569', border: 'none', color: '#0F172A', borderRadius: '0.5rem', cursor: 'pointer', fontWeight: 500 }}>Close Insights</button>
          </div>
        </div>
      )}
    </div>

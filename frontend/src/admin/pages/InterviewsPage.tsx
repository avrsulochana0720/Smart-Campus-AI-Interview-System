    ...
    <div style={{ paddingBottom: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          ...
          <button onClick={() => setScheduleModalOpen(true)} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', backgroundColor: '#E11D48', color: '#FFFFFF', border: 'none', borderRadius: '0.5rem', padding: '0.5rem 1rem', fontSize: '0.85rem', fontWeight: 700, cursor: 'pointer', boxShadow: '0 4px 12px rgba(225, 29, 72, 0.3)' }}>
            <Plus size={16} />
            Schedule Interview
          </button>
        </div>
                ...
                <td style={{ padding: '1rem', textAlign: 'right', position: 'relative' }}>
                  ...
                  {activeMenuId === interview.id && (
                    <div style={{ position: 'absolute', right: '2rem', top: '2.5rem', backgroundColor: '#FFFFFF', border: '2px solid #E11D48', borderRadius: '0.5rem', padding: '0.25rem', zIndex: 10, minWidth: '120px', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.5)' }}>
                      ...
                      <div onClick={() => handleReschedule(interview.id)} style={{ padding: '0.5rem', fontSize: '0.75rem', color: '#0F172A', cursor: 'pointer', textAlign: 'left', borderRadius: '0.25rem' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(225, 29, 72, 0.1)'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                        Reschedule
                      </div>
          ...
          <div style={{ backgroundColor: '#FAF6EE', padding: '2rem', borderRadius: '0.75rem', border: '2px solid #0F172A', width: '600px', maxWidth: '90%', maxHeight: '80vh', overflowY: 'auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                <div style={{ backgroundColor: '#FFFFFF', color: '#0F172A', padding: '1rem', borderRadius: '0.5rem', border: '2px solid #E11D48' }}>
                    <div style={{ fontSize: '0.75rem', color: '#E11D48', marginBottom: '0.25rem', fontWeight: 800 }}>Candidate ID</div>
                    <div style={{ fontSize: '1rem', color: '#0F172A', fontWeight: 800 }}>#{activeReport.user_id}</div>
                </div>
                <div style={{ backgroundColor: '#FFFFFF', color: '#0F172A', padding: '1rem', borderRadius: '0.5rem', border: '2px solid #E11D48' }}>
                    <div style={{ fontSize: '0.75rem', color: '#E11D48', marginBottom: '0.25rem', fontWeight: 800 }}>Final Score</div>
                    <div style={{ fontSize: '1rem', color: '#10B981', fontWeight: 800 }}>{activeReport.final_interview_score}/100</div>
                </div>
            </div>

  ...
  return (
    <div style={{ paddingBottom: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#FFFFFF', margin: 0 }}>Candidate Feedback Insights</h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
        {/* Overall Sentiment */}
        <div style={{ backgroundColor: '#0D1322', borderRadius: '1rem', border: '1px solid #1E293B', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <h3 style={{ fontSize: '3rem', fontWeight: 700, color: '#FFFFFF', margin: 0 }}>{totalReal > 0 ? posPct : 0}%</h3>
          <p style={{ fontSize: '0.9rem', color: '#94A3B8', marginTop: '0.5rem' }}>Positive Sentiment</p>
        ...
        <div style={{ backgroundColor: '#0D1322', borderRadius: '1rem', border: '1px solid #1E293B', padding: '2rem' }}>
          <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: '#FFFFFF', margin: '0 0 1.5rem 0' }}>Sentiment Breakdown</h3>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', marginBottom: '0.5rem' }}>
              ...
              <span style={{ color: '#FFFFFF', fontWeight: 600 }}>{totalReal > 0 ? posPct : 0}%</span>
            </div>
            <div style={{ width: '100%', height: '8px', backgroundColor: '#1E293B', borderRadius: '4px' }}><div style={{ width: `${posPct}%`, height: '100%', backgroundColor: '#22C55E', borderRadius: '4px' }}></div></div>
          </div>

          <div style={{ marginBottom: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', marginBottom: '0.5rem' }}>
              <span style={{ color: '#64748B', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Minus size={14}/> Neutral ({data.neutral})</span>
              <span style={{ color: '#FFFFFF', fontWeight: 600 }}>{totalReal > 0 ? neuPct : 0}%</span>
            </div>
            <div style={{ width: '100%', height: '8px', backgroundColor: '#1E293B', borderRadius: '4px' }}><div style={{ width: `${neuPct}%`, height: '100%', backgroundColor: '#64748B', borderRadius: '4px' }}></div></div>
          </div>

          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', marginBottom: '0.5rem' }}>
              <span style={{ color: '#EF4444', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><ThumbsDown size={14}/> Negative ({data.negative})</span>
              <span style={{ color: '#FFFFFF', fontWeight: 600 }}>{totalReal > 0 ? negPct : 0}%</span>
            </div>
            <div style={{ width: '100%', height: '8px', backgroundColor: '#1E293B', borderRadius: '4px' }}><div style={{ width: `${negPct}%`, height: '100%', backgroundColor: '#EF4444', borderRadius: '4px' }}></div></div>
          </div>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {(data.comments || []).map((comment: any, i: number) => (
            <div key={i} style={{ padding: '1rem', backgroundColor: '#111827', borderRadius: '0.5rem', borderLeft: `3px solid ${comment.color}` }}>
              ...
              <p style={{ fontSize: '0.9rem', color: '#E2E8F0', margin: 0, lineHeight: 1.5 }}>"{comment.text}"</p>
            </div>
          ))}
          {(!data.comments || data.comments.length === 0) && (
            <div style={{ color: '#64748B', fontSize: '0.85rem', padding: '1rem', textAlign: 'center', backgroundColor: '#111827', borderRadius: '0.5rem' }}>

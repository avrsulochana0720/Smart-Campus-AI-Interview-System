with open('frontend/src/admin/pages/InterviewersPage.tsx', 'r') as f:
    text = f.read()

# Define the new styled JSX return block
...
# Replace from `return (` down to the end of component
start_idx = text.find("return (")
if start_idx != -1:
    text = text[:start_idx] + new_return_block + "\n}"

with open('frontend/src/admin/pages/InterviewersPage.tsx', 'w') as f:
    f.write(text)
